...
class OptionsConnectionsTests: XCTestCase {
    ...
    func test_ConnectionsNotNil_OptionsViewController() {
        ...
        XCTAssertNotNil(sut.labelCurrentWeatherStatusMenus)
        XCTAssertNotNil(sut.labelStatusMenusUpdate)
        XCTAssertNotNil(sut.labelStatusMenus)
        XCTAssertNotNil(sut.labelToolTip)
        XCTAssertNotNil(sut.labelSecondLine)
        ...
        XCTAssertNotNil(sut.checkBoxCurrentWeatherStatusMenus)
        XCTAssertNotNil(sut.comboBoxStatusMenusUpdatePeriod)
        XCTAssertNotNil(sut.comboBoxSecondLine)
        XCTAssertNotNil(sut.comboBoxToolTipLeft)
        XCTAssertNotNil(sut.comboBoxToolTipRight)
